...
import com.tpshop.mallc.common.SPTableConstanct;
...
public class SPMobileBuiltInDBHelper extends SQLiteOpenHelper {
	...
	private boolean checkDataBase(){
		...
		try{
			String db2Path = DB2_PATH + SPMobileConstants.DB2_NAME;
			File file = new File(db2Path);
			if (file.exists() && !file.isDirectory()) {
				checkDB = SQLiteDatabase.openDatabase(db2Path, null, SQLiteDatabase.OPEN_READONLY);
			}
		}catch(Exception e){
