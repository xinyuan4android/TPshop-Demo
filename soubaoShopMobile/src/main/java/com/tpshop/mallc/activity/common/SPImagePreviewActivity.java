...
public class SPImagePreviewActivity extends Activity {
	...
	private String TAG = "SPImagePreviewActivity";
	...
	public void initSubViews() {
		...
		mPager.setAdapter(new PagerAdapter() {
			...
			public Object instantiateItem(ViewGroup container, int position) {
				...
				Glide.with(SPImagePreviewActivity.this).load(imageUrls.get(position)).placeholder(R.drawable.icon_product_null).diskCacheStrategy(DiskCacheStrategy.SOURCE).into(view);
		...
		mPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
			...
			public void onPageSelected(int position) {
				...
				//SMobileLog.i(TAG , "position : "+position);
			}
