 ...
 * @version V1.0
 */
package com.tpshop.mallc.activity.person.address;
...
import com.tpshop.mallc.view.SwitchButton.OnChangeListener;
...
public class SPConsigneeAddressEditActivity extends SPBaseActivity {
	...
	public void initData() {
		...
		if (consignee == null){
			...
			consignee.setIsDefault("0");
			submitBtn.setText(getString(R.string.address_add));
		}else{
			...
			submitBtn.setText(getString(R.string.address_edit));
