...
public class SPMobileConstants {
	...
	//启用短信验证码
	public static final boolean ENABLE_SMS_CODE = false;

	//URL
	public static final String BASE_HOST = "http://www.tpb2c.com";//"http://demo2.tp-shop.cn/";//http://www.tpshop5.cn"; //
	...
	public static final String KEY_ACTION_TYPE = "action_type";		//action type, 1: 用户注册; 2:修改找回密码
	public static final String KEY_PHONE_NUMBER = "phone_number";	//电话号码
	public static final String KEY_CHECK_CODE = "check_code";		//验证码

	/****系统所使用到的广播***/
	public static final String ACTION_SHOPCART_CHNAGE = "com.tpshop.mallc.shoprcart_change";
	public static final String ACTION_LOGIN_CHNAGE = "com.tpshop.mallc.login_change";	//登录状态改变

	/****系统常量*********/
	public static final String SP_SIGN_PRIVATGE_KEY = "www.tp-shop.cn";	//签名KEY, 同服务器一致
	...
	public static final int Result_Code_GetSelerMessage = 106;//卖家留言
	...
	/*** 第三方登录 QQ , 微信APPID , secret ***/
	public static String pluginLoginQQAppid  = "";
	public static String pluginLoginQQSecret = "";
	public static String  pluginLoginWeixinAppid = "";
	public static String  pluginLoginWeixinSecret = "";
